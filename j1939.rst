...
`1.2 Technical assistance 4 <#technical-assistance>`__
...
`5.1 Command and Status Functions 8 <#command-and-status-functions>`__

`5.2 Test Functions: 9 <#test-functions>`__

`5.3 Status: 11 <#status>`__

`5.4 Configure commands: 12 <#configure-commands>`__

`5.5 Assigning PS Numbers 15 <#assigning-ps-numbers>`__

`5.6 Data Packet 15 <#data-packet>`__

`6 Address claiming 17 <#address-claiming>`__

`6.1 Non-existence of node address:
17 <#non-existence-of-node-address>`__

`6.2 Existence of node address: 18 <#existence-of-node-address>`__
...
5. .. rubric:: Function Detail
   ...
   3. .. rubric:: Command and Status Functions
         :name: command-and-status-functions

      1. .. rubric:: Version Command:
...
Units on the bus respond with PGN message: 0x18FEDA\ ***SA[DF]***
...
Units on the bus respond with message: 0x18FDC5\ ***SA[DF]***
...
Units on the bus respond with message: 00x18FF50\ ***SA[DF]***
(default).
...
Units on the bus respond with message: 0x18FF51\ ***SA[DF]*** (default).
...
4. .. rubric:: Test Functions:
      :name: test-functions

   5. .. rubric:: Hardware bits:
         :name: hardware-bits
...
Units on the bus respond with message: 0x18FF52\ ***SA[DF]***
...
Units on the bus respond with message: 0x18FF53\ ***SA[DF]***
...
Units on the bus respond with message: 0x18FF54\ ***SA[DF]***
...
6. .. rubric:: Configure commands:
      :name: configure-commands

   7. .. rubric:: Packet rate divider:
         :name: packet-rate-divider
...
7. .. rubric:: Assigning PS Numbers
      :name: assigning-ps-numbers

   13. .. rubric:: Bank0 of PS numbers:
          :name: bank0-of-ps-numbers
...
8 bytes indicate PS for algorithm reset, save configuration, hardware
bits, software bits, status, packet rate, packet type and digital filer
selected by users if default PS is conflicted.
...
8 bytes indicate PS for orientation, user behavior, BIT, angle alarm,
cone alarm, acceleration parameter selected by users if default PS is
conflicted.

PGN message on CAN bus is 0x18FFF1\ **SA**.

8. .. rubric:: Data Packet
      :name: data-packet

   15. .. rubric:: Slope sensor information 2:
...
6. .. rubric:: Address claiming
   ...
   9. .. rubric:: Non-existence of node address:
         :name: non-existence-of-node-address
...
Request DA=255 SA=254

address claim DA=255 SA = x

address claim DA=255 SA = z

address claim DA=255 SA = w

Existence of node address:
--------------------------
...
Address claim SA=x Name A

Address claim SA=x Name B

Address Claim SA=x Name A

Address Claim SA=y Name B
